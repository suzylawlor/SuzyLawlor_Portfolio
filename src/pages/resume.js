        ...
        <div className="resume">
          ...
          <div className="func">
            ...
            <div className="skills-prog">
              ...
              A recent full stack web development graduate with a degree in Fine
              Art and a background in digital content creation and marketing
              design, seeking a challenging position as a frontend web
              developer. Possessing a strong foundation in HTML, CSS, and
              JavaScript, as well as experience with web development frameworks
              and libraries such as React, and Next.js. Experienced in creating
              engaging digital content, including website design, client
              communications and social media campaigns. Dedicated to delivering
              clean, functional, and visually appealing web solutions to
              clients. Seeking an opportunity to join a dynamic team and grow as
              a developer while contributing to the success of the organisation.
            </div>
            <div className="skills-soft">
              <h3>
                <i className="fas fa-bezier-curve"></i>Programming and Software
                Skills
              </h3>
              <ul>
                <li data-percent="90">
