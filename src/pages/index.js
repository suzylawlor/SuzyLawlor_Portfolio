...
function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-orange-50 px-4 sm:px-8 md:px-10 lg:px-20 xl:px-40 pt-6 sm:pt-8 lg:pt-10 pb-12 dark:bg-gray-800">
        <section className="relative min-h-screen">
          <div
            style={styles.circle}
            className={`absolute top-1 left-1/3 transform -translate-x-1/2 -translate-y-1/2 z-0 w-32 md:w-48 lg:w-64 h-32 md:h-48 lg:h-64 rounded-full blur-3xl ${
              darkMode ? "" : "mix-blend-multiply"
            } filter animate-blob animation-delay-1000`}
          ></div>
          <div
            style={styles.square}
            className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-2/3 z-0 w-32 md:w-48 lg:w-64 h-32 md:h-48 lg:h-64 rounded-full blur-2xl ${
              darkMode ? "" : "mix-blend-multiply"
            } filter animate-blob animation-delay-2000`}
          ></div>
          <div
            style={styles.triangle}
            className={`absolute top-1/4 right-1/2 transform -translate-x-1 -translate-y-1/2 z-0 w-32 md:w-48 lg:w-64 h-32 md:h-48 lg:h-64 rounded-full blur-3xl ${
              darkMode ? "" : "mix-blend-multiply"
