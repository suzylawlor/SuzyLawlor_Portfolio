...
function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-orange-50 px-4 md:px-10 lg:px-20 xl:px-40 pt-10 pb-16 md:pb-24 dark:bg-gray-800">
        <section className="relative h-screen md:min-h-screen">
          ...
          <nav className="text-gray-700 py-5 md:py-10 mb-8 md:mb-12 flex flex-col md:flex-row justify-between items-center dark:text-gray-50">
            <h1 className="font-burtons text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-2 md:mb-0">
              Developed by Suzy
            </h1>
          ...
          <div className="text-center p-6 md:p-10">
            ...
            <p
              style={{ position: "relative", zIndex: 1 }}
              className="text-lg md:text-3xl py-5 leading-8 text-gray-200 dark:text-gray-200 max-w-xl mx-auto"
            >
        ...
        <section className="px-4 md:px-10">
          ...
          <div className="flex flex-col md:flex-row md:justify-center lg:gap-10">
            ...
            <div className="text-center shadow-md shadow-orange-400 p-6 md:p-10 rounded-xl my-10 bg-orange-50 dark:bg-gray-800 flex-1">
              <h3 className="text-lg text-gray-800 font-medium pt-8 pb-2 dark:text-gray-50">
                Clean Code
              </h3>
              <p className="py-2 text-gray-800 dark:text-gray-50">
            ...
            <div className="text-center shadow-2xl shadow-orange-500 p-6 md:p-10 rounded-xl my-10 bg-orange-50 dark:bg-gray-800 flex-1">
              <h3 className="text-lg text-gray-800 font-medium pt-8 pb-2 dark:text-gray-50">
                Content Creation
              </h3>
              <p className="py-2 text-gray-800 dark:text-gray-50">
